			...
			thisLayout1.setVerticalGroup(thisLayout1.createSequentialGroup()
				    ...
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				        .addGroup(thisLayout1.createParallelGroup()
				            ...
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                ...
				                .addGap(7))
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                .addComponent(ukLabel1, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				                .addGap(7))
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				...
				.addGroup(thisLayout1.createParallelGroup()
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				        ...
				        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				        .addComponent(visDeltakereButton, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
				        .addGap(43))
				    .addGroup(thisLayout1.createSequentialGroup()
				        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				        .addGroup(thisLayout1.createParallelGroup()
				            .addComponent(jScrollPane2, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE)
				            .addComponent(jScrollPane1, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE))))
				            ...
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                ...
				                .addGroup(thisLayout1.createParallelGroup()
				                    ...
				                    .addGroup(thisLayout1.createSequentialGroup()
				                        .addGap(20)
				                        .addGroup(thisLayout1.createParallelGroup()
				                            .addComponent(jScrollPane1, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE)
				                            .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                                .addComponent(deltakereLabel1, GroupLayout.PREFERRED_SIZE, 94, GroupLayout.PREFERRED_SIZE)
				                                .addGap(43))
				                            .addComponent(fjernButton, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE))))
				                .addGap(41))
				        ...
				        .addGroup(thisLayout1.createParallelGroup()
				            ...
				            .addGroup(thisLayout1.createSequentialGroup()
				                ...
				                .addGroup(thisLayout1.createParallelGroup()
				                    ...
				                    .addGroup(thisLayout1.createSequentialGroup()
				                        .addComponent(leggtilButton1, GroupLayout.PREFERRED_SIZE, 142, GroupLayout.PREFERRED_SIZE)))
				                .addGap(0, 0, Short.MAX_VALUE)))
				        .addGap(226))
