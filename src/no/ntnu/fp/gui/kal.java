	...
	private void initGUI() {
		try {
			...
			thisLayout1.setVerticalGroup(thisLayout1.createSequentialGroup()
				...
				.addComponent(deltakereLabel1, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(thisLayout1.createParallelGroup()
				    .addComponent(jScrollPane2, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE)
				    .addComponent(jScrollPane1, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE)
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				        .addGap(0, 55, GroupLayout.PREFERRED_SIZE)
				        .addComponent(visDeltakereButton, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE)
				        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)))
				.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 0, GroupLayout.PREFERRED_SIZE)
				.addGroup(thisLayout1.createParallelGroup(GroupLayout.Alignment.BASELINE)
				    .addComponent(leggtilButton1, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
				    .addComponent(fjernButton, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
				    .addComponent(deltHendButton, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE))
			...
			thisLayout1.setHorizontalGroup(thisLayout1.createSequentialGroup()
				...
				.addGroup(thisLayout1.createParallelGroup()
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				        ...
				        .addGap(86))
				    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				        .addComponent(meldinger, GroupLayout.PREFERRED_SIZE, 179, GroupLayout.PREFERRED_SIZE)
				        .addGap(17))
				        ...
				        .addGroup(thisLayout1.createParallelGroup()
				            .addGroup(thisLayout1.createSequentialGroup()
				                .addGroup(thisLayout1.createParallelGroup()
				                    ...
				                    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                        .addComponent(fjernButton, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE)
				                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED))
				                    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                        .addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 138, GroupLayout.PREFERRED_SIZE)
				                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED))
				                    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
				                        .addComponent(deltakereLabel1, GroupLayout.PREFERRED_SIZE, 94, GroupLayout.PREFERRED_SIZE)
				                        .addGap(48)))
				                .addGap(22)
				                .addGroup(thisLayout1.createParallelGroup()
				                    .addComponent(leggtilButton1, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 144, GroupLayout.PREFERRED_SIZE)
				                    .addComponent(jScrollPane2, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 144, GroupLayout.PREFERRED_SIZE)
				                    .addGroup(GroupLayout.Alignment.LEADING, thisLayout1.createSequentialGroup()
